  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        //       color: Provider.of<ThemeProvider>(context,listen:false)(context).darkTheme
        //           ? Colors.black
        ...
        //           hintStyle: mulishRegular.copyWith(color: ColorResources.GAINS_BORO),
        //         ),
        //         style: mulishBold.copyWith(color: ColorResources.WHITE, fontSize: Dimensions.fontSizeLarge),
        ...
        //         style: mulishRegular.copyWith(fontSize: 20, color: ColorResources.WHITE),
        //         maxLines: 1,
