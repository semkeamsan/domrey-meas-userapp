...
class MobileVerificationScreen extends StatefulWidget {
  ...
  final String checkP;
  MobileVerificationScreen(this.tempToken, this.checkP, this.password);
                    ...
                    children: [
                      Center(
                        child: Padding(
                          ...
                          child: Image.asset(Images.otp_image,
                              ...
                              onTap: () async {
                                ...
                                if (_numberChk.isEmpty) {
                                  showCustomSnackBar(
                                      ...
                                      context);
                                  print('TempToken ${widget.tempToken}');
                                } else {
                                  authProvider
                                      .checkPhone(_number, widget.tempToken)
                                      .then((value) async {
                                    if (value.isSuccess) {
                                      // String tempToken = value.message;
                                      SMSModel().sendOTP(
                                        context: context,
                                        tempToken: widget.tempToken,
                                        phoneNumber: _countryDialCode +
                                            _numberController.text.trim(),
