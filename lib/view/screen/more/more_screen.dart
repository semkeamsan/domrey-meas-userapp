...
import 'package:flutter_sixvalley_ecommerce/view/screen/seller/seller_register_screen.dart';
            ...
            builder: (context, profile, _) {
              return Row(children: [
                Container(
                  ...
                  child: Image.asset(Images.logo_with_name_image, height: 60),
                ),
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                            ...
                            child: ListView(
                                ...
                                children: [
                                  ...
                                  Provider.of<SplashProvider>(context,
                                          ...
                                          1
                                      ? SquareButton(
                                          image: Images.score_image,
                                          title:
                                              getTranslated('scores', context),
                  ...
                  TitleButton(
                      image: Images.seller_image,
                      title: getTranslated('become_seller', context),
                      navigateTo: BecomeSellerScreen()),
    ...
    return InkWell(
      ...
      child: Column(children: [
        Padding(
          ...
          child: Container(
            width: width / (Responsive.isTab() ? 6 : 5),
            height: width / (Responsive.isTab() ? 6 : 5),
        ...
        Align(
          ...
          child: Text(title,
              style:
                  mulishRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ),
      ]),
    );
  }
