                  ...
                  return Container(
                    ...
                    child: Column(
                      children: [
                        Center(
                          child: SizedBox(
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: Responsive.isTab() ? 230 : 230,
                                ...
                                //           ),
                                //           Text(getTranslated(
                                //               'billing_address', context),style: mulishRegular),
                                //         ],
                                //       ),
                                //     ],
                                //   ),
                        ...
                        //         style: Theme.of(context).textTheme.headline2.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.green, height: 1),
                        //       ),
                        //     )
                        //   ],
                        // )
                        ...
                        //         style: Theme.of(context).textTheme.headline2.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor, height: 1),
                        //       ),
                        //     )
                        //   ],
                        // ),
