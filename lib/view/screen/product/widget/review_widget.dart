...
import 'package:flutter_sixvalley_ecommerce/view/screen/product/review_image_screen.dart';
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => ReviewImageScreen(
                            imageList: reviewModel.attachment,
                            title: reviewModel.customer.fName +
                                ' ' +
