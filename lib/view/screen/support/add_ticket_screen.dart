      ...
      child: ListView(
          ...
          children: [
            Text(getTranslated('add_new_ticket', context),
                style: mulishBold.copyWith(fontSize: 20)),
            ...
            Container(
              ...
              child: ListTile(
                ...
                title: Text(widget.type, style: mulishBold),
                onTap: () {},
              ),
            ),
            CustomTextField(
                    ...
                    builder: (context) => CustomButton(
                        ...
                        onTap: () {
                          if (_subjectController.text.isEmpty) {
                            showCustomSnackBar(getTranslated('subject_box_should_not_be_empty', context), context);
                          } else if (_descriptionController.text.isEmpty) {
                            showCustomSnackBar(
                                getTranslated('description_box_should_not_be_empty', context), context);
                          } else {
