import 'package:flutter_sixvalley_ecommerce/data/model/body/payment_method_model.dart';
...
class OrderModel {
  ...
  List<PaymentImageModel> _paymentImages;
  ...
  OrderModel({
    ...
    List<PaymentImageModel> paymentImages,
  }) {
    this._id = id;
    ...
    this._paymentImages = paymentImages;
  }
  ...
  List<PaymentImageModel> get paymentImages => _paymentImages;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['payment_images'] != null) {
      json['payment_images'].forEach((v) {
        _paymentImages.add(PaymentImageModel.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._paymentImages != null) {
      data['payment_images'] =
          this._paymentImages.map((v) => v.toJson()).toList();
    }
...
class DeliveryMan {
  ...
  String _image;
  DeliveryMan(
      {String fName, String lName, String phone, String email, String image}) {
    if (fName != null) {
      this._fName = fName;
    }
    if (lName != null) {
...
class PaymentImageModel {
  ...
  PaymentImageModel.fromJson(Map<String, dynamic> json) {
    image = json['image'];
