...
class OrderPlaceModel {
  ...
  OrderPlaceModel(
    ...
    this._paymentImage = paymentImage;
  }
  ...
  OrderPlaceModel.fromJson(Map<String, dynamic> json) {
    ...
    _paymentImage = json['payment_image_url'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['payment_image_url'] = this._paymentImage;
    data['payment_image_url'] = this._paymentMethodId;
