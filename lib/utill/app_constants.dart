...
class AppConstants {
  static const String APP_NAME = 'My Online Shopping Boutique';
  static const String APP_VERSION = '1.0.0';
  static const String BASE_URL = 'https://myonline.eocambo.com';
  ...
  static const String UPLOAD_TEMP_IMAGE_URI = '/api/v1/uploads/image';
  static const String LATEST_PRODUCTS_URI =
      '/api/v1/products/latest?limit=10&&offset=';
  static const String SELLER_REGISTRATION_URI = '/api/v2/seller/auth/register';
  ...
  static const String UPLOAD_IMAGE_URI = '/api/v1/uploads/image';
  ...
  static const String PAYMENT_METHOD_URI = '/api/v1/payment-methods';
  ...
  static const String CHECK_USER_URI = '/api/v1/auth/check-user';
